...
sed -i 's/^aws_access_key_id=.*/aws_access_key_id='""'/' access.sh
sed -i 's/^aws_secret_access_key=.*/aws_secret_access_key='""'/' access.sh
sed -i 's/^aws_session_token=.*/aws_session_token='""'/' access.sh
sed -i 's/^export TF_VAR_dockerhub_password=.*/export TF_VAR_dockerhub_password='""'/' access.sh
sed -i 's/^export TF_VAR_dockerhub_username=.*/export TF_VAR_dockerhub_username='""'/' access.sh
